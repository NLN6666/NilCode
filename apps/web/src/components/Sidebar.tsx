...
export function SidebarSurfacePicker({
  ...
  const pickerCopy = useMessages().sidebar.surfacePicker;
  const activeCopy = pickerCopy[activeView];
    ...
    return (
      ...
      >
        <ThreadHoverCardContent
          ...
          model={resolveThreadModelSummary(thread.modelSelection, m.composer.modelPicker)}
          status={hoverStatus}
        />
      </TooltipPopup>
    );
