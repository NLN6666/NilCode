...
// Purpose: Holds the address-bar sync rules, suggestions, interaction-mode state machine,
//          and renderer lifecycle guards for the in-app browser panel.
...
//          resolveNextInteractionMode, panel hide scheduling, and one-shot renderer-loss recovery
