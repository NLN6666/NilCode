...
export const browser: Messages["browser"] = {
  ...
  actions: {
    ...
    annotate: "标注页面",
    annotateElement: "标注页面元素",
    cancelAnnotateElement: "取消标注",
    annotateElementHint: "选择要标注的元素",
    cancelAnnotateElementHint: "取消选择元素（Esc）",
    copyScreenshot: "复制截图",
    copyLink: "复制链接",
    menu: "浏览器操作",
    newTab: "新建标签页",
  ...
  annotation: {
    ...
    errors: {
      ...
      freezeFailed: "无法冻结页面以进行标注。",
      elementReadFailed: "无法读取该页面元素。",
    },
  },
};
