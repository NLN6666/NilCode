...
export const settings: Settings = {
  ...
  providers: {
    ...
    tools: {
      ...
      ompPolicy: {
        ...
        sharedHome: "使用共享 ~/.omp；Synara 不设置 PI_CODING_AGENT_DIR。",
        overlay: "Synara 进程 overlay",
        memoryEffective: "有效后端",
        memoryUser: "用户配置",
        memoryFallback: "Synara 本地回退",
  ...
  models: {
    ...
    defaults: {
      ...
      modelAriaLabel: "默认模型",
      effortAriaLabel: "默认推理档位",
      contextWindowAriaLabel: "默认上下文窗口",
      modelDefault: "跟随模型默认",
      builtIn: "内置默认值",
