...
export function getDefaultModel(provider: "omp" | "pi"): null;
...
export function normalizeOhMyPiModelOptions(
  modelOptions: OhMyPiModelOptions | null | undefined,
): OhMyPiModelOptions | undefined {
  const thinkingLevel = trimOrNull(modelOptions?.thinkingLevel);
